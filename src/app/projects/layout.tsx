...
export const metadata: Metadata = {
  title: "Projects | Gautam Kumar — Full-Stack Developer | Solo-shipped 4 SaaS | AI Integration",
  description:
  ...
  openGraph: {
    title: "Projects | Gautam Kumar — Full-Stack Developer | AI-Integrated SaaS",
    description:
